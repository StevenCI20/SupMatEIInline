...
//  aAg = 107.86*g/mole;
  ...
  fMaskMaterial     = Gold;
  fObjectMaterial   = Water;
  fObject2Material  = Methacrylate;
  fObject3Material  = Air;
  fObject4Material  = PlaqueI;
  fObject5Material  = Air;
  fObject6Material  = Air;
//  fObject7Material  = Hydroxyapatite;
...
void PepiDetectorConstruction::DefineVolumes()
{
  ...
  //G4double Rmin=0.16*mm;
  G4double Rmin=0.092/2*cm;
  G4double Rmid=0.194/2*cm;
  G4double Rs=0.0*cm;
 ...
 fObject2Solid = new G4Tubs("Tube2",                         //its name
  ...
  fObject4Solid = new G4Tubs("Tube4",                         //its name
                            ...
                            fObjSizeY,                 //its half lenght Z
                            0,               //its initial phi angle
                            1.*pi);                //its angle of the segment

  fObject4Logical = new G4LogicalVolume(fObject4Solid,       //its solid
                                       fObject4Material,    //its material
                                       "Tube4LV");          //its name

  G4ThreeVector objectPosition4 = G4ThreeVector(0.*mm+fDithe, 0,0);
...
//  G4ThreeVector objectPosition4 = G4ThreeVector(-1.91*mm+fDithe, 0.59*mm, 0);
// fObject5Solid = new G4Sphere("Sphere5",
//                             0,                        //its name
//                            Rmin,
//                            0,
//                            2*pi,
//                            0,
 //                           pi);                //Radius of the sphere

//  fObject5Logical = new G4LogicalVolume(fObject5Solid,       //its solid
//                                       fObject5Material,    //its material
//                                       "Sphere5LV");          //its name

//  G4ThreeVector objectPosition5 = G4ThreeVector(-1.19*mm+fDithe, -1.61*mm, 0);
// fObject6Solid = new G4Sphere("Sphere6",
//                             0,                        //its name
//                            Rmin,
//                            0,
//                            2*pi,
...
//  G4ThreeVector objectPosition6 = G4ThreeVector(1.19*mm+fDithe, -1.61*mm, 0);

//  fObject7Solid = new G4Sphere("Sphere7",
//                             0,                        //its name
//                            Rmin,
//                            0,
//                            2*pi,
...
//  fObject7Logical = new G4LogicalVolume(fObject7Solid,       //its solid
//                                       fObject7Material,    //its material
//                                       "Sphere7LV");          //its name

//  G4ThreeVector objectPosition7 = G4ThreeVector(fDithe, 0, 0);
  
  G4RotationMatrix* rotMat =  new G4RotationMatrix();
  rotMat->rotateX(fRotAngle);
  G4RotationMatrix* rotMMat =  new G4RotationMatrix();
  rotMMat->rotateZ(0.*deg);
  G4RotationMatrix* rotMMMat =  new G4RotationMatrix();
  rotMMMat->rotateZ(90.*deg);
  
//  fObject7Physical = new G4PVPlacement(rotMat,              //its rotation
//                                      objectPosition7,       //its translation
//                                      fObject7Logical,      //its logical volume
//                                      "Sphere7",              //its name
//                                      fObjectLogical,       //its mother volume
//                                      false,               //no boolean operation
//                                      0,                   //copy number
//                                      fCheckOverlaps);     //checking overlaps
...
//                                      fCheckOverlaps);     //checking overlaps
  ...
  fObject4Physical = new G4PVPlacement(rotMMMat,              //its rotation
                                      objectPosition4,       //its translation
                                      fObject4Logical,      //its logical volume
                                      "Tube4",              //its name
                                      fObject3Logical,       //its mother volume
                                      false,               //no boolean operation
                                      0,                   //copy number
                                      fCheckOverlaps);     //checking overlaps                                     
  ...
  G4VisAttributes* objectVisAtt = new G4VisAttributes(G4Colour(1.0,1.0,1.0));
//  objectVisAtt->SetForceWireframe(true);//Gray
  ...
  G4VisAttributes* objectVisAtt2 = new G4VisAttributes(G4Colour(1.0,0.0,0.0));
//  objectVisAtt2->SetForceWireframe(true); //Red
  objectVisAtt2->SetForceSolid(true);
 //  objectVisAtt->SetForceAuxEdgeVisible(true);     
  fObject2Logical->SetVisAttributes(objectVisAtt2);

  G4VisAttributes* objectVisAtt3 = new G4VisAttributes(G4Colour(0.0,0.0,1.0));
//  objectVisAtt3->SetForceWireframe(true); //Blue
  objectVisAtt3->SetForceSolid(true);
  // objectVisAtt->SetForceAuxEdgeVisible(true);     
  fObject3Logical->SetVisAttributes(objectVisAtt3);

  G4VisAttributes* objectVisAtt4 = new G4VisAttributes(G4Colour(1.0,1.0,0.0));
//  objectVisAtt3->SetForceWireframe(true); //Yellow
  objectVisAtt4->SetForceSolid(true);
  // objectVisAtt->SetForceAuxEdgeVisible(true);     
  fObject4Logical->SetVisAttributes(objectVisAtt4);

//  G4VisAttributes* objectVisAtt5 = new G4VisAttributes(G4Colour(1.0,0.0,0.0));
//  objectVisAtt3->SetForceWireframe(true);
//  objectVisAtt5->SetForceSolid(true);
  // objectVisAtt->SetForceAuxEdgeVisible(true);     
//  fObject5Logical->SetVisAttributes(objectVisAtt5);

//  G4VisAttributes* objectVisAtt6 = new G4VisAttributes(G4Colour(1.0,1.0,0.0));
//  objectVisAtt3->SetForceWireframe(true);
//  objectVisAtt6->SetForceSolid(true);
  // objectVisAtt->SetForceAuxEdgeVisible(true);     
//  fObject6Logical->SetVisAttributes(objectVisAtt6);

//  G4VisAttributes* objectVisAtt7 = new G4VisAttributes(G4Colour(1.0,0.0,0.0));
//  objectVisAtt3->SetForceWireframe(true);
//  objectVisAtt7->SetForceSolid(true);
  // objectVisAtt->SetForceAuxEdgeVisible(true);     
//  fObject7Logical->SetVisAttributes(objectVisAtt7);
...
// Stepping and Dithering of the sample
 ...
 // object 4
  G4ThreeVector position4 = G4ThreeVector(0.*mm+fTrans+fDith, 0, 0);
  Move1("Tube4", fObject4Logical, fObject4Physical, position4,fObject3Logical,90.*deg);

// object 5
//  G4ThreeVector position5 = G4ThreeVector(0, 0, 3*cm+fSourcePosZ);
//  Move("Filter", fObject5Logical, fObject5Physical, position5,fWorldLogical,0);

 // object 6
//  G4ThreeVector position6 = G4ThreeVector(0, 0, 3*cm+fSourcePosZ+fXd2/2+fXd/2);
//  Move("Filter2", fObject6Logical, fObject6Physical, position6,fWorldLogical,0);

 // object 7
//  G4ThreeVector position7 = G4ThreeVector(fTrans+fDith, 0, 0);
//  Move("Sphere7", fObject7Logical, fObject7Physical, position7,fObjectLogical);
